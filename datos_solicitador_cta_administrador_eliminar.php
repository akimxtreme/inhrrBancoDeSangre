...
<form name="actualizar_datos" class="" id="" action="borrar_datos_administrador.php" method="post" onsubmit="return modificar_cta(this);">
...
<input class="bs" id="pd_telefono" name="pd_telefono" type="text" readonly="readonly" maxlength="12" onkeypress="return permite(event, 'num')"  onfocus="entroEnFoco(this)" value="<?php echo $telefono;?>" />
</span>
<span>
<label class="bs">Teléfono</label>
<input class="bs" id="pd_telefono" name="pd_telefono" type="text" readonly="readonly" maxlength="12" onkeypress="return permite(event, 'num')"  onfocus="entroEnFoco(this)" value="<?php echo $telefono;?>" />
...
<span>
<label class="bs">Teléfono</label>
<input class="bs" id="pd_telefono" name="pd_telefono" type="text" readonly="readonly" maxlength="12" onkeypress="return permite(event, 'num')"  onfocus="entroEnFoco(this)" value="<?php echo $estatus;?>" />
</span>
<button class="bs_java" onclick="pedir_cta_visible(this);">Eliminar cuenta</button>
