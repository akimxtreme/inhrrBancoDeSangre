...
window.open("datos_solicitador_cta.php", "Detalles de la solicitud", "directories=no, location=no, menubar=no, scrollbars=no, status=no, tittlebar=no, toolbar=no, width=725, height=300, top=50, left=100 ");
}
...
<input class="img" type='image' name='boton_submit'  src='imagenes/detalles.png' alt='Ver detalles'/>
</form></div>
<?php
}
?>
