    ...
    <form name="busqueda" method="post" action="">
		...
		if (@$_POST['boton']==='Buscar') { ?>
            ...
            <?php
			   $valor= $_POST['valor'];
			   $campo= $_POST['campo'];			   
			   $sql="SELECT * FROM administradores WHERE estatus='3' or estatus='5' and $campo like '%$valor%'";
         ...
         while ($row = mysql_fetch_array($seleccion)){
             ...
             <div class="admin">
<form class="admin" action="datos_solicitador_cta_administrador.php" method="post" >
...
<input class="admin" id="" type="text" name="correo" disabled="disabled" value="<?php echo $correo;?>" />
<input class="admin" id="" type="text" name="estatus" disabled="disabled" value="<?php echo $estatus;?>" />
