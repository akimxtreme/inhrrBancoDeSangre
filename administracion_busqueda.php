...
<h1>Consultar usuario</h1>
    ...
    <form name="busqueda" method="post" action="">
            <select name="campo">
               ...
               <option value="nombrebs">Nombre del Banco de Sangre</option>
               <option value="rif_bs">Rif del Banco de Sangre</option>
               <option value="nit_bs">Nit del Banco de Sangre</option>
            </select>
            <select name="estatus">
		...
		if (@$_POST['boton']==='Buscar') { ?>
            ...
            <?php
			   ...
			   $sql="SELECT * FROM usuarios WHERE estatus='$estatus' and $campo like '%$valor%'";
...
<input class="admin" id="" type="text" name="nombre" disabled="disabled" value="<?php echo $usuario;?>">
...
?>  
<a href="administracion_busqueda.php">Regresar al menu</a>
